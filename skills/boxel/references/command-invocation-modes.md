...
A single `Command` subclass can be exposed to users through multiple entry points. The class itself doesn't change — what changes is *how* and *where* it gets invoked. This doc names the modes, when to use each, and how to compose them.
