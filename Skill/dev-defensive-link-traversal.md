...
For **fixing** a broken link (recognising the DOM placeholder, following the URL to the linked instance, remediating), see the **Diagnosing Broken Links** skill — that is the consumer/operator side; this skill is the card-author side.
