...
// src/formulajs/bessel.ts
var import_bessel = __toESM(require_bessel(), 1);
var bessel = import_bessel.default;
function excelBesselI(xLike, nLike) {
  return bessel.besseli(parseExcelNumber(xLike), parseExcelNumber(nLike));
}
function excelBesselJ(xLike, nLike) {
  return bessel.besselj(parseExcelNumber(xLike), parseExcelNumber(nLike));
}
function excelBesselK(xLike, nLike) {
  return bessel.besselk(parseExcelNumber(xLike), parseExcelNumber(nLike));
}
function excelBesselY(xLike, nLike) {
  return bessel.bessely(parseExcelNumber(xLike), parseExcelNumber(nLike));
}

// src/bxl/bridge/formula-bessel-native.ts
...
var formulaBesselNativeFilters = wrapBareNativeFilters(bareNativeFilters);

// src/bxl/registry/formula-bessel.ts
var formulaBesselLibrary = {
  jq: {},
